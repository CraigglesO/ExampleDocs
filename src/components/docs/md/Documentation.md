...
> Stability: 0 - Deprecated (This feature is known to be problematic, and changes are
...
> Stability: 2 - Stable (The API has proven satisfactory. Compatibility with the npm ecosystem
is a high priority, and will not be broken unless absolutely necessary.)

<!-- -->

> Stability: 3 - Locked (Only fixes related to security, performance, or bug fixes will be accepted.
